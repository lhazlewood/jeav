/*
 * Copyright (c) 2008-2011 Les Hazlewood, Boxbe, Inc.
 *
 ...
 */
package com.google.code.emailaddress;
 ...
 * <ul>
 * <li>{@code bob @example.com}</li>
 * <li>{@code &quot;bob&quot;  @  example.com}</li>
 * <li>{@code bob (comment) (other comment) @example.com (personal name)}</li>
 * <li>{@code &quot;&lt;bob \&quot; (here) &quot; &lt; (hi there) &quot;bob(the man)smith&quot; (hi) @ (there) example.com (hello) &gt; (again)}</li>
 * </ul>
 * <p/>
 ...
 * <li>{@code &lt;bob@example.com&gt;}</li>
 * <li>{@code &lt;bob@example.com&gt;}</li>
 * <li>{@code &quot;personal name&quot; &lt;bob@example.com&gt;}</li>
 * <li>{@code &quot;&lt;bob \&quot; (here)&quot; &lt;&quot;bob(the man)smith&quot;@example.com&gt;}</li>
 * </ul>
 * (respectively)
 * <p/>
 * If parsing headers, however, you'll probably be calling {@link #extractHeaderAddresses(String)}.
 * <p/>
...
public class EmailAddress2 {
    ...
    public static String[] getAddressParts(String email) {
        ...
        if (m.matches()) return (getMatcherParts(m));
        else return (null);
    }
    ...
    public static String getPersonalName(String email) {
        ...
        if (m.matches()) return (getMatcherParts(m)[0]);
        else return (null);
    }
    ...
    public static String getLocalPart(String email) {
        ...
        if (m.matches()) return (getMatcherParts(m)[1]);
        else return (null);
    }
    ...
    public static String getDomain(String email) {
        ...
        if (m.matches()) return (getMatcherParts(m)[2]);
        else return (null);
    }
...
// optimize: separate method or boolean to indicate if group should be worried about at all
        ...
        List<InternetAddress> result = new ArrayList<InternetAddress>(1);
